...
* 2026: Data from January 2026

* 2015: Data from January 2015

* diff: Data from January 2026 minus data from January 2015
...
mapview(sf_data, zcol = "two_party_active_pct_2026")
```


#### Change in Active % from 2015 to 2026

Negative values indicate a percentage point decrease from 2015 to 2026. Click a county to see all of a county's data.
```{r}
